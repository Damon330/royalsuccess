    ...
    <div className="min-h-screen bg-gradient-to-br from-primary to-primary-light flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <button
          ...
          disabled
          aria-disabled="true"
          className="w-full flex items-center justify-center gap-3 border-2 border-gray-200 bg-gray-100 rounded-xl py-3 px-4 font-medium text-gray-400 min-h-touch cursor-not-allowed opacity-80"
        >
          <FcGoogle className="w-5 h-5 grayscale opacity-50" />
